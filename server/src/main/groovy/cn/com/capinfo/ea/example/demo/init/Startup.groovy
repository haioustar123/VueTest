package cn.com.capinfo.ea.example.demo.init;


import org.springframework.transaction.annotation.Transactional
import cn.com.capinfo.ea.core.annotation.CapinfoBootstrap
...
class Startup {
    ...
    private def createRequestMap() {
        if (Requestmap.count() == 0) {
            ...
            new Requestmap(name: 'img resource', url: '/img/**', configAttribute: 'permitAll').save(flush: true);
            ...
            new Requestmap(name: 'webjars', url: '/webjars/**', configAttribute: 'permitAll').save(flush: true);
            ...
            new Requestmap(name: '系统控制台', url: '/workspace2/**', configAttribute: 'isFullyAuthenticated()').save(flush: true);
