package cn.com.capinfo.ea.example.demo.domain.core;

import cn.com.capinfo.ea.core.CapinfoDomainSimpleJsonSerializer
...
class SystemLoginRecord {
    @Title(zh_CN = "登录用户")
    @JsonSerialize(using = CapinfoDomainSimpleJsonSerializer.class)
    BaseUser baseUser
    @Title(zh_CN = "访问ip地址")
    String remoteaddr
